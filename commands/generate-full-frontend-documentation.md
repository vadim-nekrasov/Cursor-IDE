...
Проведи детальный анализ предоставленной фронтенд кодовой базы и создай структурированный технический обзор проекта для
команды разработчиков. Цель: понять архитектуру, технологии, паттерны и особенности проекта.
...
- максимальное число строк в итоговом файле - 2000. При средней ширине строки - 120 символов
...
Результат сохрани в файл index.md, который помести в папку docs в корне текущего фронтенд проекта (корень это та папка,
в которой лежит package.json текущего проекта).
Если данный файл документации уже существует, то корректно обнови его со своими новыми знаниями. Так чтоб
он отражал актуальную информацию.
